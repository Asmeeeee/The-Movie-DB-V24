...
class Movies {
    fun getMovies(): List<Movie> {
        ...
        val genreAdventure = Genre(2, "adventure")
        val genreHorror = Genre(3, "horror")
        ...
        return listOf<Movie>(
            Movie(
                ...
                "tt5109280",
                listOf(genreAdventure, genreHorror)
            ...
            Movie(
                ...
                "tt11734264",
                listOf(genreAction, genreHorror)
            ),
            Movie(
                3,
                ...
                "tt12361974",
                listOf(genreAdventure, genreAction)
            ),
            Movie(
                4,
                "Tom & Jerry",
                ...
                "tt1361336",
                listOf(genreAdventure, genreAction, genreHorror)
            ),
            Movie(
                5,
                "Below Zero",
